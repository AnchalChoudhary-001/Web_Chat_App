...
function App() {
    ...
    return ( <
            ...
            div className = "col-md-2 pt-3" > {
                ...
                {
                    connected && ( < div className = "col-md-5" >
                        <
                        ...
                        <
                        div className = "col" > { typing && typing } <
                    ...
                    br / >

                        {
                            selectedUser && ( <
                                ...
                                <
                                form onSubmit = { handlePrivateMessage }
                                className = "text-center pt-3" >
                                <
                                div className = "row g-3" >
                                <
                                div className = "col-10" >
                                <
                                input value = { privateMessage.data_recc }
                                onChange = {
                                    (e) =>
                                    setPrivateMessage({
                                        ...privateMessage,
                                ...
                                <
                                div className = "col" > { /* <pre>{JSON.stringify(selectedUser.messages)}</pre> */ } <
                                ScrollToBottom className = { ROOT_CSS } > {
                                    selectedUser &&
                                    ...
                                    selectedUser.messages.map((msg, index) => ( <
                                            ...
                                            className = "alert alert-secondary" > {
                                                msg.fromSelf ?
                                                "(yourself)" : selectedUser.username
                                            } { " " } { " - " } { /* {msg.message} */ } {
